<script>
  ...
  let product = {};
  let loading = false; // Змінна для відображення завантаження
  ...
  onMount(async () => {
    loading = true; // Встановлюємо завантаження в true перед запитом
    ...
    loading = false; // Встановлюємо завантаження в false після завершення запиту
  });
</script>
